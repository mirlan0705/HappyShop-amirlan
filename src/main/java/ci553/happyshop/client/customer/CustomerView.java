...
public class CustomerView  {
    ...
    private VBox createSearchPage() {
        ...
        lbUser = new Label("Signed in as: ");
        lbUser.setStyle(UIStyle.labelStyle);
        ...
        VBox vbSearchPage = new VBox(15, hbTop, hbId, hbName, hbBtns, hbSearchResult);
    ...
    private VBox CreateTrolleyPage() {
        ...
        HBox hbBtns = new HBox(10, btnCancel, btnSignIn, btnCheckout);
    ...
    private void buttonClicked(ActionEvent event) {
        sounds.SoundPlayer.playClick(); // play button click sound
        try{
    ...
    public void update(String imageName, String searchResult, String trolley, String receipt, String username) {
        ivProduct.setImage(new Image(imageName));
        lbProductInfo.setText(searchResult);
        taTrolley.setText(trolley);

        lbUser.setText("Signed in as: " + username);
        if (!receipt.equals("")) {
