...
//warehouse delete an existing product
    ...
    public boolean checkUser(String email, String password) throws SQLException {
        ...
        String sql = "SELECT 1 FROM UserData WHERE email = ? AND password = ?";
    ...
    public boolean createUser(String email, String password) throws SQLException {
        ...
        String checkSql = "SELECT 1 FROM UserData WHERE email = ?";
        String insertSql = "INSERT INTO UserData (email, password) VALUES (?, ?)";
